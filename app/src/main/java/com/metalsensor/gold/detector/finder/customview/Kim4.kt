...
class Kim4 @JvmOverloads constructor(
    context: Context,
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawArc(frame, 125f, progressRatio * 280f, false, arcPaint)

        // Draw hand
        val angle = progressRatio * 280f + 125f // Align with arc rotation
        val matrix = Matrix()
