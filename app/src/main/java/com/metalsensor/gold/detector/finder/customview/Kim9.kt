...
class Kim9 @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : View(context, attrs, defStyleAttr) {

    private val handBitmap: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.kim4)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawArc(frame, 130f, progressRatio * 280f, false, arcPaint)

        // Draw hand
        val angle = progressRatio * 280f + 130f // Align with arc rotation
        val matrix = Matrix()

        val handWidth = dpToPx(150f)
        val handHeight = dpToPx(25f)
