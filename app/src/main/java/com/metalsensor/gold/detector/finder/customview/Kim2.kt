...
class Kim2 @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : View(context, attrs, defStyleAttr) {

    private val handBitmap: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.kim)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawArc(frame, 140f, progressRatio * 250f, false, arcPaint)

        // Draw hand
        val angle = progressRatio * 250f + 140f // Align with arc rotation
        val matrix = Matrix()

        val handWidth = dpToPx(120f)
        val handHeight = dpToPx(16f)
