...
import com.metalsensor.gold.detector.finder.databinding.ActivityResultBinding
...
@AndroidEntryPoint
class ResultActivity : BaseActivity2<ActivityResultBinding>() {
    ...
    override fun initView() {
        ...
        binding.imvTick.onSingleClick {  startActivity(
            Intent(
                this@ResultActivity,
