...
import com.metalsensor.gold.detector.finder.databinding.ActivityLanguageBinding
...
import com.metalsensor.gold.detector.finder.utils.Const.listLanguage
    ...
    private fun setClick() {
        ...
        binding.imvText.onSingleClick {
            ...
            if(codeLang.equals("")){
                ...
                SystemUtils.setPreLanguage(applicationContext, "en")
