...
public abstract class ActivityHomeBinding extends ViewDataBinding {
  ...
  @NonNull
  public final ConstraintLayout ctlGoldDector;

  @NonNull
  public final ConstraintLayout ctlMetalDector;

  @NonNull
  public final ImageView imvSt;

  @NonNull
  public final ConstraintLayout lnStatus2;

  protected ActivityHomeBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ConstraintLayout ctcoin, ConstraintLayout ctlGoldDector, ConstraintLayout ctlMetalDector,
      ImageView imvSt, ConstraintLayout lnStatus2) {
    super(_bindingComponent, _root, _localFieldCount);
    this.ctcoin = ctcoin;
    this.ctlGoldDector = ctlGoldDector;
    this.ctlMetalDector = ctlMetalDector;
    this.imvSt = imvSt;
