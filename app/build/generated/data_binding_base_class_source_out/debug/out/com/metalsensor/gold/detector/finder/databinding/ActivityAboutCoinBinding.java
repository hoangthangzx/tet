...
public final class ActivityAboutCoinBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAboutCoinBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imvBack,
  ...
  @NonNull
  public static ActivityAboutCoinBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAboutCoinBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_about_coin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAboutCoinBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAboutCoinBinding((ConstraintLayout) rootView, imvBack, imvTick, imvcoin,
