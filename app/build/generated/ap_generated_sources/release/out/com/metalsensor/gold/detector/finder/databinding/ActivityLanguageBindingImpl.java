...
public class ActivityLanguageBindingImpl extends ActivityLanguageBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.lnStatus, 2);
        sViewsWithIds.put(R.id.tvLanguage1, 3);
        sViewsWithIds.put(R.id.imvText, 4);
        sViewsWithIds.put(R.id.lnStatus_2, 5);
        sViewsWithIds.put(R.id.imvBack, 6);
        sViewsWithIds.put(R.id.tvLanguage2, 7);
        sViewsWithIds.put(R.id.imvTick, 8);
        sViewsWithIds.put(R.id.recLanguage, 9);
    }
    // views
    @NonNull
