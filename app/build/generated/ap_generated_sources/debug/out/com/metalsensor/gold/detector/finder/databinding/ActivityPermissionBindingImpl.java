...
public class ActivityPermissionBindingImpl extends ActivityPermissionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvPer, 1);
        sViewsWithIds.put(R.id.imageView2, 2);
        sViewsWithIds.put(R.id.textView5, 3);
        sViewsWithIds.put(R.id.lnNotification, 4);
        sViewsWithIds.put(R.id.imvSwitchOnMedia, 5);
        sViewsWithIds.put(R.id.imvSwitchOffMedia, 6);
        sViewsWithIds.put(R.id.lnCamera, 7);
        sViewsWithIds.put(R.id.imvSwitchOnStorage, 8);
        sViewsWithIds.put(R.id.imvSwitchOffStorage, 9);
        sViewsWithIds.put(R.id.tvContinue, 10);
    }
    // views
    @NonNull
